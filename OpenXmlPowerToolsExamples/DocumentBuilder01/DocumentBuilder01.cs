...
namespace DocumentBuilderExample
{
    class DocumentBuilderExample
    {
        static void Main(string[] args)
        {
            ...
            {
                new WmlSource(new WmlDocument(source1), 5, 10, true),
            };
            ...
            sources = new List<WmlSource>()
            {
                new WmlSource(new WmlDocument(source3), 0, 1, false),
                new WmlSource(new WmlDocument(source3), 4, false),
            };
            ...
            sources = new List<WmlSource>()
            {
                new WmlSource(new WmlDocument(source1), true),
                new WmlSource(new WmlDocument(source2), false),
            };
            ...
            sources = new List<WmlSource>()
            {
                new WmlSource(new WmlDocument(source1), false),
                new WmlSource(new WmlDocument(source2), true),
            };
            ...
            sources = new List<WmlSource>()
            {
                new WmlSource(new WmlDocument(source1), 0, 5, false),
                new WmlSource(new WmlDocument(source2), 0, 5, true),
            };
